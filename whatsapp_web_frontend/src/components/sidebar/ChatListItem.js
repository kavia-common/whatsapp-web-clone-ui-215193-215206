...
function ChatListItem({ chat, isActive, onClick }) {
  ...
  return (
    <div
      onClick={onClick}
      className={`flex items-center gap-3 px-4 py-3 cursor-pointer transition-all hover:bg-gray-50 border-b border-gray-100 ${
    ...
    >
      {/* Avatar */}
      <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-br from-primary/10 to-gray-100 flex items-center justify-center text-2xl shadow-sm">
        {contact.avatar}
      </div>
